...
public class ListTaskProgressViewSkin<T extends Task<?>> extends SkinBase<ListTaskProgressView<T>> {

    ResourceBundle resourceMessage = ResourceBundle.getBundle("resources/language", Locale.getDefault());

    static {
        StyleManager.getInstance().addUserAgentStylesheet(ListTaskProgressView.class.getResource("taskprogressview.css").toExternalForm());
    }

    public ListTaskProgressViewSkin(ListTaskProgressView<T> monitor) {
        super(monitor);
        ...
        listView.setPlaceholder(new Label(resourceMessage.getString("main.task.none")));
    ...
    class TaskCell extends ListCell<T> {
        ...
        public TaskCell() {
            ...
            cancelButton = new Button(resourceMessage.getString("main.cancel"));
            cancelButton.getStyleClass().add("task-cancel-button");
            cancelButton.setTooltip(new Tooltip(resourceMessage.getString("main.cancel")));
